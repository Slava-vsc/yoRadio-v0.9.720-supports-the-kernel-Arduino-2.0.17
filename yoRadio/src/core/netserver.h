...
<title>yoRadio - WEB Board Завантажувач</title><style>html, body { margin: 0; padding: 0; height: 100%; } body{background-color:#000;color:#e3d25f;font-size:20px;display:flex;flex-direction:column;}
...
<section>
<h2>yoRadio - WEB Board Завантажувач</h2>
<hr />
<span>Виберіть <u>ВСІ</u> файли з <i>yoRadio/data/www/</i><br />та завантажте їх за допомогою форми нижче</span>
<hr />
...
<hr />
<span>-= ДОДАТКОВО =-<br />Ви також можете завантажити файли <i>playlist.csv</i><br />та <i>wifi.csv</i> з резервної копії</span>
<p><label for="data">wifi:</label><input type="file" name="data" id="data" multiple></p>
<hr />
<p><input type="submit" name="submit" value="Завантажити файли"></p>
</form>
<div style="padding:10px 0 0;" id="wupload">
<hr />
<form name="wifiform" method="post" enctype="multipart/form-data">
<span>-= ДОДАТКОВО =-<br />Якщо ви не можете підключитися з ПК до адреси 192.168.4.1, <br />спочатку налаштуйте з’єднання Wi-Fi</span>
...
<p><input type="submit" name="submit" value="Зберегти облікові дані"></p>
</form>
</div>
</section>
<p><a href="/emergency">аварійне завантаження прошивки</a></p>
<div id="copy">powered by <a target="_blank" href="https://github.com/e2002/yoradio/">yoRadio</a><span id="version"></span></div>
</body>
<script>
